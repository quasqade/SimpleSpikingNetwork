...
public class Layer
{
	...
	public Layer(int neuronAmount)
	{
		...
		{
			neuronList.add(new Neuron(Neuron.NeuronType.IZHIKEVICH, 3)); //TODO postsynaptic delay is chosen randomly
		}
	...
	public void interconnectToPrevious(Layer layer, double initialWeight, double minWeight, double maxWeight)
	{
