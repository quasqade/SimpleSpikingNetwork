...
/**
 * Created by user on 16-Feb-18. Spike represents a voltage spike travelling along an axon
 */
public class Spike {
  ...
  public boolean advance() {
    counter--;
    return (counter
        > 0); //if counter reaches zero, return false to signify arrival at target neuron
  }
